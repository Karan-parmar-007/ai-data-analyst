...
def lasso(
    ...
    """
    Trains a Lasso regression model using the provided data and hyperparameters.
    ...
    """
    try:
        # Initialize the Lasso model with provided hyperparameters.
        model = Lasso(
            alpha=alpha,
        ...
        logging.info("Starting training for Lasso regression.")
        ...
        # Record a simple progress metric (currently, the final training MSE).
        progress = [train_mse]
        ...
        logging.info(f"Lasso regression trained in {train_time:.2f} seconds. Artifacts stored: {store_response}")
        ...
        logging.error(f"Error in Lasso training: {e}")
