...
def multinomial_nb(
    ...
    """
    Trains a MultinomialNB model using the provided data and hyperparameters.
    ...
    """
    try:
        # Initialize the MultinomialNB model with the provided hyperparameters.
        model = MultinomialNB(
            alpha=alpha,
        ...
        logging.info("Starting training for MultinomialNB.")
        ...
        logging.info(f"MultinomialNB trained in {train_time:.2f} seconds. Artifacts stored: {store_response}")
        ...
        logging.error(f"Error in MultinomialNB training: {e}")
